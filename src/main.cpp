...
hittable_list simple_light()
{
    ...
    auto ball = std::make_shared<solid_color>(color(0.1, 0.2, 0.6));
    objects.add(std::make_shared<sphere>(point3(0, -1000, 0), 1000, std::make_shared<lambertian>(ball)));
    objects.add(std::make_shared<sphere>(point3(0, 2, 0), 2, std::make_shared<lambertian>(ball)));
...
hittable_list cornell_smoke()
{
    ...
    auto white = make_shared<lambertian>(color(.73, .73, .73));
    auto green = make_shared<lambertian>(color(.12, .45, .15));
    auto light = make_shared<diffuse_light>(color(1, 1, .80));
    ...
    shared_ptr<hittable> box1 = make_shared<box>(point3(0,0,0), point3(165,660,165), white);
    box1 = make_shared<rotate_y>(box1, 15);
    box1 = make_shared<translate>(box1, vec3(265,0,295));
